...
<body>
	...
	<main class="container mt-4">
		...
		<button onclick="location.href='${pageContext.request.contextPath}/employee/empMain'"
        ...
        $(document).ready(function() {
            ...
            function confirmDelete(employeeId) {
                if (confirm("確定要刪除此員工嗎？")) {
                    $.ajax({
                        url: "${pageContext.request.contextPath}/employee/delete?employeeId=" + employeeId,
                        type: 'GET',
